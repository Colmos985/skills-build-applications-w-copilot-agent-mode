        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="card p-5 text-center">
              ...
              <p className="lead">Track your activities, join teams, and climb the leaderboard!</p>
              <Link to="/activities" className="btn btn-success btn-lg m-2">View Activities</Link>
              <Link to="/leaderboard" className="btn btn-warning btn-lg m-2">See Leaderboard</Link>
            </div>
          } />
        </Routes>
      </div>
